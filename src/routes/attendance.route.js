...
router.get('/admin/today', authenticateAdmin, attendanceController.getTodaysAttendanceCount)
router.get('/admin/report', authenticateAdmin, attendanceController.getAttendanceReport)
